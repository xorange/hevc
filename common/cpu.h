 ...
 * cpu.h: cpu detection
 *****************************************************************************
 * Copyright (C) 2004-2012 x265 project
 *
...
int      x265_cpu_num_processors( void );
void     x265_cpu_emms( void );
void     x265_cpu_sfence( void );
#if HAVE_MMX
...
#define x265_emms() asm volatile( "emms":::"memory","st","st(1)","st(2)", \
...
#define x265_emms()
#endif
#define x265_sfence x265_cpu_sfence
void     x265_cpu_mask_misalign_sse( void );
...
int x265_stack_align( void (*func)(), ... );
...
extern const x265_cpu_name_t x265_cpu_names[];
