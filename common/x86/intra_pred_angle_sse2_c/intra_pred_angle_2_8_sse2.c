...
x265_pred_angle_help_func x265_pred_angle_help_2_8_sse2[35] =
{
		0,
		0,
		0,
		x265_intra_pred_angle_h_26_2_8_sse2,
		x265_intra_pred_angle_h_21_2_8_sse2,
		x265_intra_pred_angle_h_17_2_8_sse2,
		x265_intra_pred_angle_h_13_2_8_sse2,
		x265_intra_pred_angle_h_9_2_8_sse2,
		x265_intra_pred_angle_h_5_2_8_sse2,
		x265_intra_pred_angle_h_2_2_8_sse2,
		0,
		x265_intra_pred_angle_h_m2_2_8_sse2,
		x265_intra_pred_angle_h_m5_2_8_sse2,
		x265_intra_pred_angle_h_m9_2_8_sse2,
		x265_intra_pred_angle_h_m13_2_8_sse2,
		x265_intra_pred_angle_h_m17_2_8_sse2,
		x265_intra_pred_angle_h_m21_2_8_sse2,
		x265_intra_pred_angle_h_m26_2_8_sse2,
		0,
		x265_intra_pred_angle_v_m26_2_8_sse2,
		x265_intra_pred_angle_v_m21_2_8_sse2,
		x265_intra_pred_angle_v_m17_2_8_sse2,
		x265_intra_pred_angle_v_m13_2_8_sse2,
		x265_intra_pred_angle_v_m9_2_8_sse2,
		x265_intra_pred_angle_v_m5_2_8_sse2,
		x265_intra_pred_angle_v_m2_2_8_sse2,
		0,
		x265_intra_pred_angle_v_2_2_8_sse2,
		x265_intra_pred_angle_v_5_2_8_sse2,
		x265_intra_pred_angle_v_9_2_8_sse2,
		x265_intra_pred_angle_v_13_2_8_sse2,
		x265_intra_pred_angle_v_17_2_8_sse2,
		x265_intra_pred_angle_v_21_2_8_sse2,
		x265_intra_pred_angle_v_26_2_8_sse2,
};
...
void x265_intra_pred_angle_2_8_sse2(pixel *left,
									pixel *top,
									pixel* dst,
									int i_dst_stride,
									int i_chroma_idx,
									int i_mode)
{
    ...
    if (intraPredAngle < 0)
    {
        refMain = ref_array+16 ;
        if (modeVer)
        {
        	memcpy(refMain, top-1, sizeof(pixel)*17) ;
        }
        else
        {
        	memcpy(refMain, left-1, sizeof(pixel)*17) ;
        }
    ...
    if (intraPredAngle == 0)  // Exactly hotizontal/vertical angles
    {
        if (modeHor)
        {
            ...
            if (10 == i_mode && 0 == i_chroma_idx)
            {
                ...
                v_side = _mm_loadu_si128(((__m128i const*)(refSide + 1)));
                ...
                v_side = _mm_loadu_si128(((__m128i const*)(refSide + 9)));
                v_side = _mm_sub_epi16(v_side, v_side_0);
                v_side = _mm_srai_epi16(v_side, 1);
                ...
                _mm_storeu_si128((__m128i*)temp_dst, row01);            //row0
                _mm_storeu_si128((__m128i*)(temp_dst+8), row02);            //row0
            	temp_dst += i_dst_stride ;
            }
            else
            {
				tmp1 = _mm_set1_epi16(temp_ref_main[0]);
				for ( k = 0 ; k < 2 ; ++ k )
				{
        ...
        else
        {
            ...
            if (26 == i_mode && 0 == i_chroma_idx)
            {
                ...
                _mm_storeu_si128((__m128i*)row0_array, row0);            //row0
                for ( j = 0 ; j < 8 ; ++ j )
                {
                	temp_dst[0] = row0_array[j];
                	temp_dst += i_dst_stride ;
                }
    ...
    else if (intraPredAngle == -32)
    {
        ...
        x265_intra_pred_angle_m32_2_8_sse2 (refMain, dst, i_dst_stride) ;
        return;
    }
    else if (intraPredAngle == 32)
    {
        refMain += 2;
        x265_intra_pred_angle_32_2_8_sse2 (refMain, dst, i_dst_stride) ;
        return;
    }
    else
    {
        x265_pred_angle_help_2_8_sse2[i_mode] ( refMain + 1, dst, i_dst_stride ) ;
        return ;
    }
}
    ...
    if (intraPredAngle == 0)  // Exactly hotizontal/vertical angles
    {
        if (modeHor)
        {
            ...
            if (10 == i_mode && 0 == i_chroma_idx)
            {
                ...
                _mm_storeu_si128((__m128i*)temp_dst, tmp1);            //row0
            	temp_dst += i_dst_stride ;
            }
            else
            {
				tmp1 = _mm_set1_epi8(temp_ref_main[0]);
