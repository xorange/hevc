...
x265_pred_angle_help_func x265_pred_angle_help_4_8_sse2[35] =
{
		0,
		0,
		0,
		x265_intra_pred_angle_h_26_4_8_sse2,
		x265_intra_pred_angle_h_21_4_8_sse2,
		x265_intra_pred_angle_h_17_4_8_sse2,
		x265_intra_pred_angle_h_13_4_8_sse2,
		x265_intra_pred_angle_h_9_4_8_sse2,
		x265_intra_pred_angle_h_5_4_8_sse2,
		x265_intra_pred_angle_h_2_4_8_sse2,
		0,
		x265_intra_pred_angle_h_m2_4_8_sse2,
		x265_intra_pred_angle_h_m5_4_8_sse2,
		x265_intra_pred_angle_h_m9_4_8_sse2,
		x265_intra_pred_angle_h_m13_4_8_sse2,
		x265_intra_pred_angle_h_m17_4_8_sse2,
		x265_intra_pred_angle_h_m21_4_8_sse2,
		x265_intra_pred_angle_h_m26_4_8_sse2,
		0,
		x265_intra_pred_angle_v_m26_4_8_sse2,
		x265_intra_pred_angle_v_m21_4_8_sse2,
		x265_intra_pred_angle_v_m17_4_8_sse2,
		x265_intra_pred_angle_v_m13_4_8_sse2,
		x265_intra_pred_angle_v_m9_4_8_sse2,
		x265_intra_pred_angle_v_m5_4_8_sse2,
		x265_intra_pred_angle_v_m2_4_8_sse2,
		0,
		x265_intra_pred_angle_v_2_4_8_sse2,
		x265_intra_pred_angle_v_5_4_8_sse2,
		x265_intra_pred_angle_v_9_4_8_sse2,
		x265_intra_pred_angle_v_13_4_8_sse2,
		x265_intra_pred_angle_v_17_4_8_sse2,
		x265_intra_pred_angle_v_21_4_8_sse2,
		x265_intra_pred_angle_v_26_4_8_sse2,
...
void x265_intra_pred_angle_4_8_sse2(pixel *left,
									pixel *top,
									pixel* dst,
									int i_dst_stride,
									int i_chroma_idx,
									int i_mode)
{
    ...
    ALIGNED_ARRAY_16( pixel, ref_array,[144] );
    pixel* refMain;
    pixel* temp_ref_main;
    pixel* refSide;
    pixel* temp_dst;
    ...
    if ( -32 == intraPredAngle )
    {
        refMain = ref_array+64 ;
        if (modeVer)
        {
        	memcpy(refMain, top-1, sizeof(pixel)*65) ;
        }
        else
        {
        	memcpy(refMain, left-1, sizeof(pixel)*65) ;
        }
        ...
        x265_intra_pred_angle_m32_4_8_sse2 (refMain, dst, i_dst_stride) ;

        return;
    }
    else if (intraPredAngle == 32)
    {
        refMain = (modeVer ? top : left) + 1;
        x265_intra_pred_angle_32_4_8_sse2 (refMain, dst, i_dst_stride) ;
    ...
    {
        x265_pred_angle_help_4_8_sse2[i_mode] ( refMain + 1, dst, i_dst_stride ) ;
    }
}
...
#define PREDANG_CALCROW_VER_MODE2(X) { \
  ...
  \
        ...
        it2 = _mm_mullo_epi16(it1, row15); \
        it3 = _mm_mullo_epi16(v_deltaFract, row25); \
        it2 = _mm_add_epi16(it2, it3); \
        it2 = _mm_add_epi16(it2, i16); \
        res1 = _mm_srai_epi16(it2, 5); \
        it2 = _mm_mullo_epi16(it1, row16); \
        it3 = _mm_mullo_epi16(v_deltaFract, row26); \
        it2 = _mm_add_epi16(it2, it3); \
        it2 = _mm_add_epi16(it2, i16); \
        res2 = _mm_srai_epi16(it2, 5); \
  \
        itmp = _mm_packus_epi16(res1, res2); \
        _mm_storeu_si128((__m128i*)(dst + ((X)*i_dst_stride) + 32), itmp); \
        it2 = _mm_mullo_epi16(it1, row17); \
        it3 = _mm_mullo_epi16(v_deltaFract, row27); \
        it2 = _mm_add_epi16(it2, it3); \
        it2 = _mm_add_epi16(it2, i16); \
        res1 = _mm_srai_epi16(it2, 5); \
        it2 = _mm_mullo_epi16(it1, row18); \
        it3 = _mm_mullo_epi16(v_deltaFract, row28); \
        it2 = _mm_add_epi16(it2, it3); \
        it2 = _mm_add_epi16(it2, i16); \
        res2 = _mm_srai_epi16(it2, 5); \
  \
        itmp = _mm_packus_epi16(res1, res2); \
        _mm_storeu_si128((__m128i*)(dst + ((X)*i_dst_stride) + 48), itmp); \
}
									...
									int i_mode)
{
    ...
    //	refMain[-79] - refMain[-64]
    //	refMain[-63] - refMain[  0]
    //	refMain[  1] - refMain[ 64]
    //	ref_array
    ALIGNED_ARRAY_16( pixel, ref_array,[144] );
    pixel* refMain;
    pixel* temp_ref_main;
